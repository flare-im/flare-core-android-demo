...
android {
    ...
    defaultConfig {
        ...
        // 客户端不再持有签名密钥。可用 `-PhttpUrl=...` 覆盖。
        val defaultHttpUrl = (project.findProperty("httpUrl") as String?) ?: "http://10.0.2.2:50050"
...
dependencies {
    ...
    implementation("com.flare.im:im-ui-compose:1.0.10")
